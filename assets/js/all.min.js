function loadJS(A, e, t) {
    ...
    ,
    a.src = A,
    t ? document.getElementById(t).appendChild(a) : r.insertBefore(a, r.firstChild)
}
$.fn.extend({
...
var duoshuoQuery = {
  ...
  , General = {
    ...
    init: function() {
        ...
        "micromessenger" == e.match(/MicroMessenger/i) && (General.isWechat = !0,
        $("body").addClass("wechat-webview")),
        t && (General.isMobile = !0),
        $("body").hasClass("post-template") && (General.updateImageWidth(),
    ...
    scrollToPos: function(A) {
        var e = "我要飞到最高"
          , t = (A || $(window).height(),
        $('<a href="#" id="to-top" title="' + e + '"> <div class="to-top-wrap"></div></a>').appendTo("body"));
    ...
    rewardLoader: function() {
        ...
        $(".money-like .reward-button").click(function() {
            $(this).hasClass("active") ? ($(this).find("img.wechat-img").attr("src", A.wechat),
            $(this).find("img.alipay-img").attr("src", A.alipay),
            $(".money-code").fadeOut(),
            $(this).removeClass("active")) : ($(".money-code").fadeIn(),
            $(this).addClass("active"))
        })
    },
     commentLoader: function() {
        ...
        $(window).scroll(function() {
            if ($(".author-image").isOnScreenVisible() && !$(".author-image").hasClass("comment-loaded")) {
                ...
                t.src = "https://blog-earthc-moe.disqus.com/embed.js",
                t.setAttribute("data-timestamp", +new Date),
                loadJS("https://blog-earthc-moe.disqus.com/embed.js", function() {
...
$(document).ready(function() {
    ...
    $.fn.lazyload = function(e) {
        ...
        $.extend(a, e)),
        o = void 0 === a.container || a.container === window ? A : $(a.container),
        ...
        this.each(function() {
            var A = this
              , e = $(A);
            A.loaded = !1,
            void 0 !== e.attr("src") && e.attr("src") !== !1 || e.is("img") && (e.attr("src", a.placeholder),
            e.addClass("loading")),
            e.one("appear", function() {
                if (!this.loaded) {
                    ...
                    (o.indexOf("upaiyun") > -1 || o.indexOf("file.is26.com") > -1) && (1 == a.advanced_load && (o += "!"),
